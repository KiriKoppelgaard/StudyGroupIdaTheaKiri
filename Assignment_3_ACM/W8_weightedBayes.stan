...
model {
  ...
  for (n in 1:N){  
  target += bernoulli_logit_lpmf(y[n] | weight_f(Source1[n], weight1) + weight_f(Source2[n], weight2));
  }
}
...
generated quantities{
  ...
  for (n in 1:N){  
    log_lik[n] = bernoulli_logit_lpmf(y[n] | weight_f(Source1[n], weight1) + weight_f(Source2[n], weight2));
  }
