...
ggplot() + 
  geom_histogram(aes(data$SecondRating), color="darkblue", fill="blue", alpha=0.3) + 
  geom_density(aes(round(draws_df$`prior_preds[137,1]`*9, 0)), color="green", fill="green", alpha=0.3) + 
...
#testing new plot
ggplot(draws_df) +
  geom_density(aes(`prior_preds[137,1]`*9))
