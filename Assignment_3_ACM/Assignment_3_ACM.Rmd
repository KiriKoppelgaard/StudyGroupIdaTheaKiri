...
ggplot(data, aes(x=Feedback, y=Change,fill="red")) +
  ...
  ggtitle("Change as a function of feedback")
...
##Plotting posteriors
```{r}
#Plotting priors and posteriors for w1
ggplot(draws_df) + 
  geom_density(aes(w1_prior), color = 'red') + 
    geom_density(aes(w1), color = 'blue')

#Plotting priors and posteriors for w2
ggplot(draws_df) + 
  geom_density(aes(w2_prior), color = 'red') + 
    geom_density(aes(w2), color = 'blue')
